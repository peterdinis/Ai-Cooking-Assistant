            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto text-center space-y-12">
                ...
                >
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                        Unlock culinary creativity with our AI-powered assistant.
                        From pantry staples to gourmet meals, we guide you every step of the way.
                    </p>
                </motion.div>
                ...
                >
                    <span className="text-sm text-muted-foreground font-medium mr-2 self-center">Try:</span>
                    {suggestions.map((s) => (
                        <button
                            key={s}
                            onClick={() => setQuery(s)}
